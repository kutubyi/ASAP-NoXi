...
def build_model(params_config, params_model):
	...
	output_au1_intensity = tf.squeeze(Dense(1, activation='linear', name='AU1_int')(x), axis=-1)
	output_au2_intensity = tf.squeeze(Dense(1, activation='linear', name='AU2_int')(x), axis=-1)
	output_au4_intensity = tf.squeeze(Dense(1, activation='linear', name='AU4_int')(x), axis=-1)
	output_au5_intensity = tf.squeeze(Dense(1, activation='linear', name='AU5_int')(x), axis=-1)
	output_au6_intensity = tf.squeeze(Dense(1, activation='linear', name='AU6_int')(x), axis=-1)
	output_au7_intensity = tf.squeeze(Dense(1, activation='linear', name='AU7_int')(x), axis=-1)
	output_au12_intensity = tf.squeeze(Dense(1, activation='linear', name='AU12_int')(x), axis=-1)
